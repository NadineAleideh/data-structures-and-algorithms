...
Also, Feel free to check the [LinkedListTests.cs](c-sharp/DataStructures/DataStructures/DataStructuresTests/LinkedListTests.cs) file for the complete Tests details.
